...
const HomePage: React.FC<HomePageProps> = ({ navigateTo, language }) => {
  ...
  return (
    <div className="min-h-full w-full p-4 md:p-6 lg:p-10 flex flex-col max-w-7xl mx-auto">
        <div className="flex-grow flex flex-col items-center justify-center animate-fade-in-up py-10 md:py-20">
            <div className="text-center px-4">
                ...
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-on-surface dark:text-dark-on-surface tracking-tight mb-6 leading-tight">
                    {t.welcome}
                </h1>
                <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-500 dark:text-gray-400 leading-relaxed">
                    {t.sub}
                </p>
            </div>
        </div>
        ...
        <div className="w-full pb-6">
             {/* Responsive Grid: Vertical on mobile (1 col), Grid on Desktop (2/3 cols) */}
