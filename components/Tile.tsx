...
const Tile: React.FC<TileProps> = ({ section, navigateTo, className = "" }) => {
    ...
    return (
        ...
        >
            ...
            <div className="mt-auto pt-4 flex items-center text-sm font-semibold text-primary dark:text-dark-primary opacity-0 transform translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
