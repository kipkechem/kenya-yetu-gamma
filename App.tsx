...
const KenyaLawsPage = lazy(() => import('./components/KenyaLawsPage'));
const ConstitutionExplorer = lazy(() => import('./ConstitutionExplorer'));
const InfoMapPage = lazy(() => import('./components/InfoMapPage'));
const ProjectsPage = lazy(() => import('./components/ProjectsPage'));
const ResourcesPage = lazy(() => import('./components/ResourcesPage'));
const AboutUsPage = lazy(() => import('./components/AboutUsPage'));
const ContactPage = lazy(() => import('./components/ContactPage'));
const ActsPage = lazy(() => import('./components/ActsPage'));
const ActDetailPage = lazy(() => import('./components/ActDetailPage'));
const CabinetPage = lazy(() => import('./components/CabinetPage'));
const StateCorporationsPage = lazy(() => import('./data/StateCorporationsPage'));
const CountyGovernmentsPage = lazy(() => import('./components/CountyGovernmentsPage'));
const MyRepresentativesPage = lazy(() => import('./components/MyRepresentativesPage'));
const AnthemPage = lazy(() => import('./components/AnthemPage'));
const AnthemsListPage = lazy(() => import('./components/AnthemsListPage'));
const SymbolPage = lazy(() => import('./components/SymbolPage'));
const CountyLawsPage = lazy(() => import('./components/CountyLawsPage'));
const ChatPage = lazy(() => import('./components/ChatPage'));
const HistoricalDocumentsPage = lazy(() => import('./components/HistoricalDocumentsPage'));
