        ...
        <div className="max-w-5xl mx-auto space-y-10">
            ...
            <header className="text-center mb-8">
              ...
              <p className="max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                  KenyaYetu.co.ke is an emerging civic awareness platform designed to help Kenyans better understand their <span className="text-primary dark:text-dark-primary font-semibold">rights, responsibilities, and opportunities for participation</span> in public life. Our goal is to support a more informed, engaged, and accountable society, where citizens feel confident taking part in conversations that shape Kenya’s future.
              </p>
            </header>
            ...
            {/* Community Engagement & Founder */}
            <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-primary/5 dark:bg-primary/10 p-8 rounded-3xl border border-primary/10">
                    <h2 className="text-xl font-bold text-on-surface dark:text-dark-on-surface mb-4">Community Engagement (Our Future Direction)</h2>
                    <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                        KenyaYetu ultimately seeks to promote participatory planning by:
                    </p>
                    <ul className="space-y-3">
                        {['Helping communities understand development issues', 'Encouraging civic dialogue and advocacy', 'Supporting citizens, youth groups, and local organizations to participate meaningfully in governance'].map((item, i) => (
                ...
                <div className="bg-surface dark:bg-dark-surface p-8 rounded-3xl custom-shadow border border-border dark:border-dark-border">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-4">
                        KenyaYetu was founded by <a href="https://www.linkedin.com/in/mkbartonjo/" target="_blank" rel="noopener noreferrer" className="text-primary dark:text-dark-primary hover:underline font-semibold">Michael Bartonjo</a>, an RTPI-accredited urban planner with experience in urban planning, port-city operations, spatial analysis, and infrastructure research.
                    </p>
                    <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                        His work reflects a commitment to user-centered design, sustainability, and contributing to Kenya’s long-term development.
                    </p>
                </div>
            </div>
