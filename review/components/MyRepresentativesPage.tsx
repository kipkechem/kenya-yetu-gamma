...
import { IdentificationIcon, UsersIcon } from './icons';
import { representativesData } from '../data/representatives';
import type { Representative } from '../types';

// Create a unique set of county names from representatives data for the dropdown
const countyOptions = ['All', ...Array.from(new Set(representativesData.map(r => r.county).filter(Boolean))) as string[]];
