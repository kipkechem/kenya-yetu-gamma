...
export const chapter18: Chapter = {
  id: 18,
  title: 'Masharti ya Mpito na Matokeo',
  parts: [
    {
      title: '',
      articles: [
        ...
        },
        {
          number: '262',
          title: 'Masharti ya mpito na matokeo',
          content: `Masharti ya mpito na matokeo yaliyowekwa katika Jedwali la Sita yataanza kutumika tarehe ya kuanza kutumika.`
        },
        {
          number: '263',
          title: 'Tarehe ya Kuanza Kutumika',
          content: `Katiba hii itaanza kutumika wakati wa kutangazwa kwake na Rais au mwishoni mwa kipindi cha siku kumi na nne kutoka tarehe ya kuchapishwa katika Gazeti la Serikali la matokeo ya mwisho ya kura ya maoni ya kuidhinisha Katiba hii, yoyote itakayotangulia.`
        },
        {
          number: '264',
          title: 'Ufutaji wa Katiba ya awali',
          content: `Katiba iliyokuwa ikitumika mara moja kabla ya tarehe ya kuanza kutumika inafutwa tarehe ya kuanza kutumika, kwa kuzingatia Jedwali la Sita.`
        }
      ]
    }
  ]
