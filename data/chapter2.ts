      ...
      articles: [
        {
          ...
          content: `(1) Kenya is a sovereign Republic.
(2) The Republic of Kenya shall be a multi-party democratic State founded on the national values and principles of governance referred to in Article 10.`,
        ...
        },
        {
          ...
          content: `(1) The territory of Kenya is divided into the counties specified in the First Schedule.
...
(3) A national State organ shall ensure reasonable access to its services in all parts of the Republic, so far as it is appropriate to do so having regard to the nature of the service.`,
        },
        {
          ...
          content: `(1) The national language of the Republic is Kiswahili.
...
(b) promote the development and use of indigenous languages, Kenyan Sign language, Braille and other communication formats and technologies accessible to persons with disabilities.`,
        ...
        { number: '8', title: 'State and religion', content: `There shall be no State religion.` },
        {
          number: '9',
          title: 'National symbols and national days',
          content: `(1) The national symbols of the Republic are—
(a) the national flag;
...
(5) Parliament may enact legislation prescribing other public holidays, and providing for observance of public holidays.`,
        },
        {
          ...
          content: `(1) The national values and principles of governance in this Article bind all State organs, State officers, public officers and all persons whenever any of them—
...
(d) sustainable development.`,
        },
        {
          number: '11',
          title: 'Culture',
          content: `(1) This Constitution recognises culture as the foundation of the nation and as the cumulative civilization of the Kenyan people and nation.
(2) The State shall—
